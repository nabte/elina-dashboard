...
`
    ...
    if (context.ragContext) {
        prompt += `\n## 📚 BASE DE CONOCIMIENTOS (LA VERDAD ABSOLUTA)\n`
        prompt += `Usa esta información para responder preguntas generales, servicios o características, INCLUSO SI NO hay productos específicos en la base de datos:\n`
