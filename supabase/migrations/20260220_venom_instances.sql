-- =========================================
-- MIGRACIÓN: Sistema Venom WhatsApp Multi-Tenant
-- Fecha: 2026-02-20
...
-- - Auto-asignación según nivel de plan del usuario
...
-- =========================================
-- 11. DATOS DE PRUEBA (Solo en desarrollo)
-- =========================================

-- Descomentar para insertar datos de prueba:
/*
INSERT INTO venom_instances (user_id, session_id, status, webhook_url, phone_number)
VALUES
    ((SELECT id FROM profiles WHERE email = 'test@example.com' LIMIT 1), 'test-session-001', 'disconnected', 'https://webhook.site/test', '+5211234567890');
*/
...
-- Test 1: Usuario NO puede crear más instancias que su límite
-- (Insertar como usuario con plan business, intentar crear 2 instancias → 2da falla)

-- Test 2: Usuario solo ve sus propias instancias
-- SELECT * FROM venom_instances; -- Solo debe retornar las del usuario autenticado

-- Test 3: SuperAdmin ve todas las instancias
-- (Autenticarse como superadmin)
-- SELECT * FROM venom_instances; -- Debe retornar TODAS las instancias

-- Test 4: Obtener estadísticas
-- SELECT get_venom_usage_stats(auth.uid());

-- Test 5: Verificar límite por plan
-- SELECT get_venom_instance_limit(auth.uid());
...
BEGIN
    ...
    RAISE NOTICE '✓ RLS habilitado con políticas por plan';
