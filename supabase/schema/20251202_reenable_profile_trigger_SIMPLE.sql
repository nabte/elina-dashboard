...
-- VERSIÓN SIMPLE - Sin bloques DO anidados
-- ============================================

-- Paso 1: Re-habilitar el trigger
ALTER TABLE auth.users ENABLE TRIGGER on_auth_user_created;

-- Paso 2: Crear/actualizar la función handle_new_user directamente
-- (No se puede crear dentro de un bloque DO $$)
...
-- Paso 4: Verificar que el trigger está habilitado
SELECT 
