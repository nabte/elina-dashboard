-- ============================================
-- Actualizar solo la función handle_new_user
-- NO modifica el trigger (requiere permisos de superusuario)
-- ============================================

-- Paso 1: Verificar estado actual del trigger (solo lectura)
SELECT 
...
-- Paso 3: Crear/actualizar la función handle_new_user
...
SELECT 
    'Función actualizada correctamente ✅' as resultado,
    proname as function_name
FROM pg_proc
WHERE proname = 'handle_new_user';
