...
(function () {
    ...
    async function handleBulkStatusChange(shouldActivate) {
        ...
        const confirmed = window.appModal?.confirm
            ? await window.appModal.confirm(`¿${actionCapitalized} todos los productos visibles según los filtros actuales? Esta acción afectará múltiples productos.`, '⚠️ Confirmar acción masiva')
            : confirm(`⚠️ ¿${actionCapitalized} todos los productos visibles según los filtros actuales?\n\nEsta acción afectará múltiples productos.`);
